...
export function DueDateCard({ 
  ...
  return (
    <div className={`p-2 rounded-lg shadow-sm border-2 border-l-4 min-h-[240px] max-h-[260px] flex flex-col justify-between ${cardColorClass} ${hasConnectionIssue ? 'ring-2 ring-red-200' : ''}`}>
      <div className="mb-2">
