              ...
              {isLoggedIn ? (
                <>
                  <button 
                    ...
                    disabled={refreshing}
                    className="bg-gray-100 hover:bg-gray-200 disabled:bg-gray-50 text-gray-900 font-medium py-2 pl-1 pr-3 rounded-lg border border-gray-300 hover:border-gray-400 transition-all flex items-center justify-start space-x-2 text-xs whitespace-nowrap relative overflow-hidden group"
                  >
