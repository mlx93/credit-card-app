  ...
  const mockCards = [
    {
      ...
      balanceLimit: 15000,
      nextPaymentDueDate: '2025-01-15', // Due this month
    ...
    },
    {
      ...
      balanceLimit: 10000,
      nextPaymentDueDate: '2025-01-20', // Due this month
    ...
    },
    {
      ...
      balanceLimit: 8000,
      nextPaymentDueDate: '2024-12-25', // Overdue (past due)
      minimumPaymentAmount: 85.00,
    },
  ];

  const mockCycles = [
    // Current/Recent Cycles - Chase Sapphire Preferred
    {
      id: 'cycle-1',
    ...
    // Current/Recent Cycles - Capital One Venture
    {
      id: 'cycle-3',
    ...
    // OVERDUE Cycle - American Express Gold
    {
      id: 'cycle-5',
      ...
      paymentStatus: 'outstanding', // This makes it overdue
    },
    {
      id: 'cycle-6',
      creditCardId: 'mock-card-3',
